...
@v1.route("/tickets/<string:team_slug>/<string:pkey>/<string:ticket_key>/next", methods=["GET"])
def ticket_next(team_slug, pkey, ticket_key):
    return jsonify(message="Not implemented")

@v1.route("/tickets/<string:team_slug>/<string:pkey>/<string:ticket_key>/prev", methods=["GET"])
